...
import { knowledgeReadinessLabel, resolveKnowledgeReadiness, sortAiModelsByPreference } from './formatters'
...
describe('formatters', () => {
  ...
  it('sorts ai models with DeepSeek first and OpenAI second', () => {
    const sorted = sortAiModelsByPreference([
      ...
      { providerCode: 'DEEPSEEK', modelCode: 'deepseek-chat', modelName: 'DeepSeek Chat', supportStream: true },
